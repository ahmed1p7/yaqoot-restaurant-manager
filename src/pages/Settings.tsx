...
export const Settings = () => {
  ...
  const [perSeatCharge, setPerSeatCharge] = useState(systemSettings.perSeatCharge.toString());
  ...
  const handleEmergencyModeChange = (checked: boolean) => {
    ...
    toast.success(checked ? "تم تفعيل وضع الطوارئ" : "تم إيقاف وضع الطوارئ");
    // In a real app, this would update the system settings
  };
  
  const handleBackupPrinterEnabledChange = (checked: boolean) => {
    setBackupPrinterEnabled(checked);
    toast.success(checked ? "تم تفعيل الطابعة الاحتياطية" : "تم إيقاف الطابعة الاحتياطية");
  };
  
  const handleBackupPhoneEnabledChange = (checked: boolean) => {
    setBackupPhoneEnabled(checked);
    toast.success(checked ? "تم تفعيل إشعارات الطوارئ" : "تم إيقاف إشعارات الطوارئ");
  };
